...
public class RoleController {
    ...
    @GetMapping
    @CrossOrigin(origins = "*", maxAge = 3600)
    public ResponseObjectType<RoleModel> getPage(@RequestParam(name = "size", required = false, defaultValue = "10") int size,
...
//        return new ResponseEntity<>(response, HttpStatus.OK);
        return  roleService.getPageSize(keyword, page, size, field, sort);
    }
